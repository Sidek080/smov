# Contributing Guidelines for ReelZone
...
## Contents
- [Contributing Guidelines for ReelZone](#contributing-guidelines-for-ReelZone)
  - [Contents](#contents)
...
### GitHub Issues
To make a GitHub issue for ReelZone, please visit the [new issue page](https://github.com/sussy-code/smov/issues/new/choose) where you can pick either the "Bug Report" or "Feature Request" template.
...
GitHub issues are how we track our bugs and feature requests that will be implemented into ReelZone - all contributions **must** have an issue and be approved by a maintainer before a pull request can be worked on.
...
## Contributing
If you're here because you'd like to work on an issue, amazing! Thank you for even considering contributing to ReelZone; it means a lot :heart:
...
Our recommended development environment to work on ReelZone is:
...
- Keep as much as possible to the style of ReelZone. Look around our codebase to familiarise yourself with how we do things!
...
Language contributions help ReelZone massively, allowing people worldwide to use our app!

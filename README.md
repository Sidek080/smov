# ReelZone
[![ReelZone Image](.github/ReelZone.png)](https://docs.undi.rest)  
...
|----------------|------------------------------------------------------------------|----------------------------------------------------------|
| ReelZone Docs | [sudo-docs](https://docs.undi.rest)                          | [source code](https://github.com/sussy-code/docs)        |
...
| Frontend       | [ReelZone](https://docs.undi.rest/instances)                | [source code](https://github.com/sussy-code/smov)        |
...
## Running Locally
Type the following commands into your terminal / command line to run ReelZone locally
```bash
...
## Updating a ReelZone Instance
To update a ReelZone instance you can type the below commands into a terminal at the root of your project.
```bash
...
git commit -m "Update ReelZone instance (merge upstream/main)"
git push  # Push to YOUR repository
```


## Contact Me
**Email:** *[dev@ReelZone.lol](mailto:dev@ReelZone.lol)* 
